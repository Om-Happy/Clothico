package com.clothico.custom_exception_handler;
...
import com.clothico.custom_exceptions.ResourseNotFoundException;
...
public class GlobalExceptionHandler {
	...
	public ApiResponse handleAnyException(RuntimeException e) {
		System.out.println("in catch-all of GlobalException " + e);
		return new ApiResponse(e.getMessage());
	}
}
